      ...
      <div className="overflow-x-auto pb-2">
        <div className="mx-auto flex min-w-max flex-col items-center gap-8">
          <div className="w-full max-w-lg space-y-1.5">
            ...
            />
            <div className="animate-screen-glow rounded-md bg-gradient-to-b from-screen to-slate-400 py-1.5 text-center text-xs font-bold uppercase tracking-[0.35em] text-slate-900 [transform:perspective(30rem)_rotateX(32deg)]">
              Screen
            </div>
            <p className="text-center text-[0.65rem] uppercase tracking-widest text-slate-500">
              All eyes this way
            </p>
          </div>
          ...
          <div className="flex w-full items-center gap-3 text-[0.65rem] font-semibold uppercase tracking-widest text-slate-500">
